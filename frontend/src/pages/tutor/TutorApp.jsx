...
import { BookOpen, Users, Calendar, LogOut, Sparkles } from 'lucide-react'
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <div className="hidden sm:block text-right">
                <p className="text-xs font-medium text-slate-700 leading-none">{tutor.name}</p>
                <p className="text-xs text-slate-400 mt-0.5">ID #{tutor.tutor_id}</p>
              </div>
            </div>
